    ...
    public static void main(String[] args) {
     ...
     while(true)
     {
       ...
       number = input.nextDouble();  
        ...
        else if(op == '^'){result = Math.pow(result, number); System.out.println("Result = " + result); }
       ...
       
       {
        ...
        else if(op == 't' || op == 'T'){result = Math.tan(number); System.out.println("Result = " + result);}
        ...
        else if(op == 'a' || op == 'A'){ result = Math.abs(result);
         System.out.println("Result = " + result);}
